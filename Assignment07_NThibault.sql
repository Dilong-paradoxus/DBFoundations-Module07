...
-- 2025-06-01,NThibault,Started Editing
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_NThibault')
	 Begin 
	  Alter Database [Assignment07DB_NThibault] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_NThibault;
	 End
	Create Database Assignment07DB_NThibault;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_NThibault;
...
SELECT
	ProductName,
	DateName(mm,InventoryDate) + ', ' + DateName(YEAR,InventoryDate),
	Count
FROM vProducts
 JOIN vInventories
